        ...
        try {
            ...
            if (rs.next()) {
                ...
                if (banned > 0 && !gm) {
                    ...
                    if (loginstate > MapleClient.LOGIN_NOTLOGGEDIN && loginstate != MapleClient.LOGIN_LOGGEDIN) { // already loggedin
                        loggedIn = false;
                        loginok = 7;
                    } else {
...
//                        }
     ...
     * @return
     */
    public WriteFuture sendPacket(MaplePacket packet) {
        return this.getSession().write(packet);
    }
