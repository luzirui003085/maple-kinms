            ...
            case 5050000: { // AP Reset
                ...
                switch (apto) { // AP to
                    ...
                    case 2048: // 运气
                        ...
                        break;
                    case 8192: // HP
                        if (playerst.getMaxHp() >= 32767) {
                            used = false;
                        }
                        break;
                    case 32768: // MP
                        if (playerst.getMaxMp() >= 32767) {
                            used = false;
                        }
                        break;
                }
                switch (apfrom) { // AP to
                    ...
                    case 0x800: // luk
                        ...
                        break;
                    case 0x2000: // hp
                        if (playerst.getMaxHp() >= 32767 || c.getPlayer().getHpApUsed() <= 0 || c.getPlayer().getHpApUsed() >= 10000 || playerst.getMaxHp() < 1) {
                            used = false;
                        }
                        break;
                    case 0x8000: // mp
                        if (playerst.getMaxMp() >= 32767 || c.getPlayer().getHpApUsed() <= 0 || c.getPlayer().getHpApUsed() >= 10000 || playerst.getMaxMp() < 1) {
                            used = false;
                        }
                        break;
                }
